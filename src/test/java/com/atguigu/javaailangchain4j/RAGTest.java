...
public class RAGTest {
    ...
    public void testReadDocument() {
        ...
        //Document document = FileSystemDocumentLoader.loadDocument("D:\\BaiduNetdiskDownload\\Xiaozhi资料\\knowledge\\knowledge\\测试.txt\\");
        //System.out.println(document.text());
        // 从一个目录中加载所有的.txt文档
        PathMatcher pathMatcher = FileSystems.getDefault().getPathMatcher("glob:*.txt");
        List<Document> documents = FileSystemDocumentLoader.loadDocuments("D:\\BaiduNetdiskDownload\\Xiaozhi资料\\knowledge\\knowledge",
    ...
    public void testParsePDF() {
        Document document = FileSystemDocumentLoader.loadDocument("D:\\BaiduNetdiskDownload\\Xiaozhi资料\\knowledge\\knowledge\\医院信息.pdf", new ApachePdfBoxDocumentParser()
        );
    ...
    public void testReadDocumentAndStore() {
        ...
        Document document = FileSystemDocumentLoader.loadDocument("D:\\BaiduNetdiskDownload\\Xiaozhi资料\\knowledge\\knowledge\\人工智能.md");
        //为了简单起见，我们暂时使用基于内存的向量存储   InMemoryEmbeddingStore
